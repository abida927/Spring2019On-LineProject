...
public class Quize2 {
	...
	public static void main(String[] args) {
		 ...
		 * }
		 * 
		 * A. ACDE B. ABC C. ABDE C. Compile Error
		 * 
		 */
		 ...
		 * 
		 * int wd=0; String[] days= {"sun","mon","wed","sat"};
		 * 
		 * for(int i=0; i<days.length; i++) {
		 * 
		 * switch (days[i]) { case "sat": case "sun": wd -=1; break; case "mon": wd++;
		 * case "wed": wd += 2; } }
		 * 
		 * System.out.println(wd);
		 * 
		 * A. 0 B. 4 C. compile error D. 3 ( Correct)
		 * 
		 */
		 ...
		 * 
		 * String[][] arr= { {"A","B","C"}, {"D","E"} }; for(int i=0; i<arr.length; i++)
		 * { for(int j=0; j<arr[i].length; j++) { if(arr[i][j].equals("B")) { break; }
		 * System.out.print(arr[i][j]); } }
		 * 
		 * A. ADE ( Correct) B. ABDE C. ACDE D. Compile Error
		 * 
		 */
		// A DE
		 ...
		 * 
		 * int[] num1=new int[3]; int[] num2= {1,2,3,4,5}; num1=num2; for(int i=0;
		 * i<num1.length; i++) { System.out.print(num1[i]); }
		 * 
		 * A. 000 B. 12345 ( correct) C. Compile Error D. 123
		 * 
		 * 
		 */
		 ...
		 * 
		 * int[] arr1 = {1,2,3,4,5}; for( XXX ) { System.out.print(arr1[e]); }
		 * 
		 * Which option can replace xxx to enable the code to print 135 ?
		 * 
		 * A. int e = 0; e < 5; e += 2 (correct) B. int e = 1; e <= 5; e += 1 C. int e =
		 * 0; e <= 4; e++ D. int e = 1; e < 5; e +=2
		 * 
		 * 
		 */
		 ...
		 * what's the result?
		 * 
		 * A. Compilation fails (Correct) B. 100 C. 101 D. 102
		 * 
		 */
		 ...
		 * }
		 * 
		 * line 1 { int max =0; return max;
		 * 
		 * }
		 * 
		 * A. static int findMax (int[] numbers) ( Correct) B. public int findMax (int[]
		 * numbers) // static only accepts static ( directly ) C. static int[] findMax
		 * (int max) D. static int findMax (int numbers)
		 * 
		 * 
		 */

		/*
		 * 9. What's the result of the following code fragment? public static void
		 * main(String[] args) { int num = 10; add10(num); System.out.println(num);
		 * 
		 * } public static void add10(int num) { num=num+10;
		 * 
		 * }
		 * 
		 * A. 0 B. 10 ( Correct) C. compile error D. 20
		 * 
		 * 
		 */
	}
