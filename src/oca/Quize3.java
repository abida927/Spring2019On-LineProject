...
// java 
		...
		boolean b1 = (str1 == str3); // ==? why false?
...
//	Y1=Y2;
		 ...
		 * 
		 * int numbers[]; numbers[0] = 10; numbers[1] =20; numbers=new int[4];
		 * numbers[2]=30; numbers[3]=40; System.out.println(Arrays.toString(numbers));
		 * 
		 * }
		 * 
		 * 
		...
		/*
		 * 
		 * 6. Given: public static void main(String[] args) { String stuff ="TV"; String
		 * res="";
		 * 
...
//    }
		 ...
		 * shirts[1][0]="small"; shirts[1][1]="medium"; Line 1 *** }
		 * 
