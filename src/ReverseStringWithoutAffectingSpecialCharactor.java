...
public class ReverseStringWithoutAffectingSpecialCharactor {
	...
	public static void main(String[] args) {
		...
		String str="abc...efg**h";
		String strLetter=str.replaceAll("\\W", "");
		//System.out.println(str);
		String rev="";
		int lastIndex=strLetter.length()-1;
		for(int i =0; i <str.length();i++) {
			char temp = str.charAt(i);
			if(Character.isLetter(temp)) {
				rev += strLetter.charAt(lastIndex);
				lastIndex--;
			}else {
				rev +=temp;
			}
